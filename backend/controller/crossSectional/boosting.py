...
def _run_continuous(X_train, X_test, y_train, y_test):
    """Original Gradient Boosting regression path — unchanged."""
...
def _run_binary(X_train, X_test, y_train, y_test, threshold=0.5):
    """
    Gradient Boosting classifier for binary (0/1) targets.
    Uses GradientBoostingClassifier instead of GradientBoostingRegressor.
